...
class Incremental:
    ...
    @staticmethod
    def update_potential_function(network, src_idx, potential_function):
        ...
        def update_value(node_idx, edge_weight, successor_idx):
            def decrease_key(min_heap, node_idx, new_key):
                pass
            ...
            return True
        min_heap = []
        heapq.heappush(min_heap, (src_idx, updated_potential_function[src_idx]))
